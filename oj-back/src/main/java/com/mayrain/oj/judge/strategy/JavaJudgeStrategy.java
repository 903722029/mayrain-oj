...
public class JavaJudgeStrategy implements JudgeStrategy{
    ...
    public JudgeInfo doJudge(JudgeContext judgeContext) {
        ...
        List<String> expectedOutputList = judgeCaseList.stream().map(JudgeCase::getOutputCase)
        ...
        // 假设 java 需要多花10秒
        Long JAVA_EXECUTE_COST = 100000L;
        if (time - JAVA_EXECUTE_COST > expectedTimeLimit) {
