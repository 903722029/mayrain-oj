...
const codeHandleChange = (code: string) => {
    ...
    <a-row :gutter="[24, 24]">
      ...
      <a-col :md="12" :xs="24">
        ...
        <CodeEditor
          ...
          :code-value="form.code as string"
          :code-handle-change="codeHandleChange"
        />
        <a-divider size="0"></a-divider>
        <a-button type="primary" style="min-width: 140px" @click="doSubmit"
          >提交代码
        </a-button>
      </a-col>
    </a-row>
